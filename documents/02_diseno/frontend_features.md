...
**Producto:** 0.10.7 (incluye feature `cronograma`).  
...
| `/v2/cronograma` | `cronograma` | `PrivateRoute` |
| `/v2/cronograma/:id` | `cronograma` | `PrivateRoute` |
...
| `configuracion` | `ConfiguracionPage`, AreaForm, UsuarioForm | `organizacionService.js` | Solo Administrador en UI; gerencias + CRUD de áreas (I-017) |
...
| `cronograma` | ListPage, MatrizPage, CantidadPopover, PersonalPanel | `cronogramaService.js` | D-007 / I-017; menú «Cronograma»; Xn = cantidad; PDF A4 L–V 2 meses; bandas de gerencia; HORA PROGRAMADA con borde; baja del plan |
...
5. No añadir feature `reportes`: los PDF se disparan desde inventario/mantenimiento/**cronograma**.
...
- Feature `cronograma/` implementado en 0.10.0 (I-010).
