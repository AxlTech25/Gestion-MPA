...
| DEG-004 | Configurar `ml_service_url` vacío (simula Hostinger) | Login + inventario OK; `/ml/status` degradado | AVA-04 | CMP-003, M-001 |
...
Núcleo (login, inventario, mantenimiento) OK con ML down. Release institucional **no** espera uvicorn en Hostinger.
