...
|---------------------------------------|----------------|
| Parte de los prompts se documentó a posteriori; no todo el código nació con un registro R/D/I/T/M | Registrar el prompt **antes o durante** el cambio, no al final |
...
| Hay pocos ADR y métricas D2 aún gruesas | Medir tiempo de ciclo, iteraciones por prompt, defectos post-entrega |
